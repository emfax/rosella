...
export default class RosellaElement extends LitElement {
  ...
  static dependencies: Record<string, typeof RosellaElement> = {};

  constructor() {
    super();

    Object.entries((this.constructor as typeof RosellaElement).dependencies).forEach(([name, component]) => {
      (this.constructor as typeof RosellaElement).define(name, component);
    });
  }
  ...
  attributeChangedCallback(name: string, oldValue: string | null, newValue: string | null) {
    if (!this.#hasRecordedInitialProperties) {
      (this.constructor as typeof RosellaElement).elementProperties.forEach(
        // @ts-ignore
...
export interface RosellaFormControl extends RosellaElement {
